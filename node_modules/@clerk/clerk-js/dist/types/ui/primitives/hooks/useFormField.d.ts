...
export declare const sanitizeInputProps: (obj: ReturnType<typeof useFormField>, keep?: (keyof ReturnType<typeof useFormField>)[]) => {
    type?: "number" | "reset" | "submit" | "password" | "search" | "button" | "time" | "image" | "text" | "email" | "month" | "file" | "hidden" | "url" | "color" | "checkbox" | "radio" | (string & {}) | "date" | "datetime-local" | "range" | "tel" | "week" | undefined;
    name: FieldId;
    options?: {
        value: string;
        label?: string;
